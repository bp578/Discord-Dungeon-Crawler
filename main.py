...
@bot.command()
async def ng(ctx):
  userData = state.get_player_data(ctx.author)
...
data = {
  ...
  #Player Status. The current state of the player. 
  #For example, a player's current HP may be lower than their HP because of a battle with a monster.
  "CurrentHP: ": 100
}
